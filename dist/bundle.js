...
exports.editedOrder = editedOrder;
...
var _Order = __webpack_require__(20);
...
var _ChangeView = __webpack_require__(22);

var _ChangeView2 = _interopRequireDefault(_ChangeView);
...
function products() {
    ...
    if (action.type == 'FETCH_PRODUCT_SUCCESS') {
        ...
        var newState = state.filter(function (s) {
            return s._id == action.payload;
        });
        return newState;
    } else {
...
function fetchProducts() {
    return function (dispatch) {
        fetch('https://a2-webpro-s3-2017.herokuapp.com/products').then(function (res) {
            return res.json();
        }).then(function (data) {
            dispatch({
...
function editedProduct() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { name: '', age: 0 };
    var action = arguments[1];
...
function fetchCategories() {
    return function (dispatch) {
        fetch('https://a2-webpro-s3-2017.herokuapp.com/categories').then(function (res) {
            return res.json();
        }).then(function (data) {
            dispatch({
...
function fetchOrders() {
    return function (dispatch) {
        fetch('https://a2-webpro-s3-2017.herokuapp.com/orders').then(function (res) {
            return res.json();
        }).then(function (data) {
            dispatch({
...
function fetchCarts() {
    return function (dispatch) {
        fetch('http://bestlab.us:8080/shoppingCarts').then(function (res) {
            return res.json();
        }).then(function (data) {
            dispatch({
...
var centralState = (0, _redux.combineReducers)({ products: products, editedProduct: editedProduct, categories: categories, editedCategory: editedCategory, orders: orders, editedOrder: editedOrder, carts: carts });
var store = (0, _redux.createStore)(centralState, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./product-styles.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./product-styles.css");
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            this.props.dispatch((0, _main.fetchProducts)());
        }
    }, {
        ...
        value: function handleSave() {
            if (this.state.id === '' || this.state.name === '' || this.state.price === '' || this.state.description === '' || this.state.brand === '' || this.state.producer === '') {
                alert('Please check the form');
                return false;
            } else {
                if (this.state._id === undefined || this.state._id === '') this.props.dispatch((0, _main.addProduct)(this.state));else this.props.dispatch((0, _main.updateProduct)(this.state));
            }
        }
    }, {
        key: 'handleAddToCart',
        value: function handleAddToCart(newState) {
            console.log(newState);
            this.props.dispatch((0, _main.addToCart)(newState));
        }
    }, {
        key: 'handleDelete',
        value: function handleDelete(_id) {
            if (confirm('Do you want to delete?')) {
                ...
                this.props.dispatch((0, _main.deleteProduct)(_id));
            }
        }
    }, {
        key: 'handleView',
        value: function handleView(_id) {
        ...
        value: function handleEdit(id) {
            this.props.dispatch((0, _main.getProduct)(id));
        }
    }, {
        key: 'handleChange',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.products.map(function (product) {
                        return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'button',
                                                { disabled: product.exist > 0 ? '' : 'disable' },
                            ...
                            _react2.default.createElement('img', { className: 'image1', src: product.imageUrl }),
                            _react2.default.createElement('br', null),
                            _react2.default.createElement(
                                'div',
                                { className: 'footer' },
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    _react2.default.createElement(
                                                        ...
                                                        { onClick: function onClick() {
                                                                return _this2.handleDelete(product._id);
                                                            } },
                                                        _react2.default.createElement('img', { className: 'icon', src: './icons/rubbish-bin.png' })
                                                    )
                                                ),
                                                _react2.default.createElement(
                                                    'td',
                                                    ...
                                                    _react2.default.createElement(
                                                        'a',
                                                        { onClick: function onClick() {
                                                                return _this2.handleEdit(product._id);
                                                            } },
                                                        _react2.default.createElement('img', { className: 'icon', src: './icons/new-file.png' })
                                                    )
                                                ),
                                                _react2.default.createElement(
                                                    'td',
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    _react2.default.createElement(
                                                        ...
                                                        { onClick: function onClick() {
                                                                ...
                                                                _this2.handleAddToCart(newState);
                                                            } },
                                                        _react2.default.createElement('img', { className: 'icon', width: '25px', height: '20px', src: './icons/cart.png' })
                                                    )
                                                )
                                            )
                                        )
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'table',
                        { style: { width: "50%", borderWidth: "2px", borderColor: "#dddddd" } },
                        _react2.default.createElement(
                            'tbody',
                            null,
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'text', name: 'id', value: this.state.id,
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'text', name: 'price', value: this.state.price,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'text', name: 'description', value: this.state.description,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'text', name: 'brand', value: this.state.brand,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'text', name: 'producer', value: this.state.producer,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'number', name: 'exist', value: this.state.exist,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'text', name: 'imageUrl', value: this.state.imageUrl,
                                        onChange: this.handleChange.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('input', { type: 'button', className: 'button', value: 'Save', onClick: function onClick() {
...
var Order = function (_React$Component) {
    ...
    _createClass(Order, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.props.dispatch((0, _main.fetchOrders)());
        }
    }, {
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(props) {
        ...
        key: 'handleSave',
        value: function handleSave() {
            if (this.state._id === undefined || this.state._id === '') this.props.dispatch((0, _main.addOrder)(this.state));else this.props.dispatch((0, _main.updateOrder)(this.state));
        }
    }, {
        key: 'handleDelete',
        value: function handleDelete(_id) {
            if (confirm('Do you want to delete?')) {
                ...
                this.props.dispatch((0, _main.deleteOrder)(_id));
            }
        }
    }, {
        key: 'handleView',
        ...
        key: 'handleEdit',
        value: function handleEdit(id) {
            this.props.dispatch((0, _main.getOrder)(id));
        }
    }, {
        key: 'handleChange',
        value: function handleChange(e) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'td',
                                null,
                                _react2.default.createElement('input', { type: 'text', name: 'email', value: this.state.email,
                                    onChange: this.handleChange.bind(this) })
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'td',
                                null,
                                _react2.default.createElement('input', { type: 'text', name: 'phone', value: this.state.phone,
                                    onChange: this.handleChange.bind(this) })
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'td',
                                null,
                                _react2.default.createElement('input', { type: 'text', name: 'address', value: this.state.address,
                                    onChange: this.handleChange.bind(this) })
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'td',
                                null,
                                _react2.default.createElement('input', { type: 'text', name: 'orderDate', value: this.state.orderDate,
                                    onChange: this.handleChange.bind(this) })
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'td',
                                null,
                                _react2.default.createElement('img', { src: this.state.imageUrl, width: '40px', height: '40px' })
                            )
                        ),
                        _react2.default.createElement(
                            'tr',
                            ...
                            _react2.default.createElement(
                                'td',
                                null,
                                _react2.default.createElement('input', { type: 'text', name: 'total', value: this.state.total,
                                    onChange: this.handleChange.bind(this) }),
                                '$'
                            )
                        )
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'footer' },
                    _react2.default.createElement('input', { type: 'button', className: 'button', value: 'Save', onClick: this.handleSave.bind(this) })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'header' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.props.orders.map(function (i) {
                                return _react2.default.createElement(
                                    'tr',
                                    ...
                                    _react2.default.createElement('img', { src: i.imageUrl, width: '40px', height: '40px' }),
                                    _react2.default.createElement(
                                        'td',
                                        null,
                                        _react2.default.createElement(
                                            'button',
                                            { type: 'button', className: 'button', value: 'Delete', onClick: function onClick() {
                                                    return _this2.handleDelete(i._id);
                                                } },
                                            'Delete'
                                        )
                                    ),
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'button',
                                            { type: 'button', className: 'button', value: 'Update', onClick: function onClick() {
                                                    return _this2.handleEdit(i._id);
                                                } },
                                            'Edit'
                                        )
                                    )
...
var Categories = function (_React$Component) {
    ...
    _createClass(Categories, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.props.dispatch((0, _main.fetchCategories)());
        }
    }, {
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(props) {
        ...
        key: 'handleSave',
        value: function handleSave() {
            if (this.state._id === undefined || this.state._id === '') this.props.dispatch((0, _main.addCategory)(this.state));else this.props.dispatch((0, _main.updateCategory)(this.state));
        }
    }, {
        key: 'handleDelete',
        value: function handleDelete(_id) {
            if (confirm('Do you want to delete?')) {
                ...
                this.props.dispatch((0, _main.deleteCategory)(_id));
            }
        }
    }, {
        key: 'handleEdit',
        value: function handleEdit(id) {
            this.props.dispatch((0, _main.getCategory)(id));
        }
    }, {
        key: 'handleChange',
        value: function handleChange(e) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.props.categories.map(function (i) {
                                return _react2.default.createElement(
                                    'tr',
                                    { style: { textAlign: "center" } },
                                    _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'button',
                                            { className: 'button', value: 'Update', onClick: function onClick() {
                                                    return _this2.handleEdit(i._id);
                                                } },
                                            _react2.default.createElement('img', { className: 'icon', src: './icons/new-file.png' })
                                        )
...
var ChangeView = function (_React$Component) {
    _inherits(ChangeView, _React$Component);

    function ChangeView() {
        _classCallCheck(this, ChangeView);

        var _this = _possibleConstructorReturn(this, (ChangeView.__proto__ || Object.getPrototypeOf(ChangeView)).call(this));
                ...
                _react2.default.createElement(
                    ...
                    this.props.products.map(function (product, i) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement('br', null),
                            _react2.default.createElement('img', { className: 'image2', src: product.imageUrl }),
                            _react2.default.createElement('br', null),
                            _react2.default.createElement(
                                'div',
                                { key: i, className: 'footer' },
                                _react2.default.createElement(
                                    'table',
                                    null,
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { className: 'button', value: 'Delete', onClick: function onClick() {
                                                        return _this2.handleDelete(product._id);
                                                    } },
                                                _react2.default.createElement('img', { className: 'icon', src: './icons/rubbish-bin.png' })
                                            )
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { className: 'button', value: 'Edit', onClick: function onClick() {
                                                        return _this2.handleEdit(product._id);
                                                    } },
                                                _react2.default.createElement('img', { className: 'icon', src: './icons/new-file.png' })
                                            )
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { href: '#', type: 'button', onClick: function onClick(e) {
                                                        var id = product.id;
                                                        var name = product.name;
                                                        var price = product.price;
                                                        var description = product.description;
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement('img', { className: 'hide', width: '25px', height: '20px', src: './icons/cart.png' })
                                            )
                                        )
                                    )
                                )
...
// module
exports.push([module.i, "\n.container li{\n    list-style-type: none;\n}\n.big{\n    width: 100%;\n    height: 250%;\n    background-image: url(http://www.yummycrumbs.co.uk/wp-content/uploads/2016/12/nice-background.jpg);\n    background-repeat: repeat;\n\n}\n.banner{\n    background-color: pink;\n    margin-left: 13%;\n    width: 75%;\n}\n.banner img{\n    margin-left: 11%;\n    width: 80%;\n}\n .tag{\n    background-color: peachpuff;\n    text-align: center;\n    margin-left: 13%;\n    width: 75%;\n    height: 4%;\n }\n .tag-left{\n    \n     float: left;\n     width: 75%;\n }\n .tag-right{\n    float: left;\n     width: 25%;\n }\n .tag-left ul{\n     \n     list-style-type: none;\n }\n .tag-left ul li{\n     width: 20%;\n     float: left;\n    \n}\n\n.tag-left ul li a:hover{\n    color: green;\n}\n\n.tag-left ul li:hover{\n    background-color: #dddddd;   \n}\n .tag-right ul{\n    list-style-type: none;\n}\n .tag-right ul li{\n    width: 60%;\n    float: left;\n    \n }\n .tag-right ul li:hover{\n    background-color: darkseagreen;\n }\n .tag-right ul li a{\n     color:brown;\n    text-decoration: none ;\n}\n .components{\n     background-color:rgb(221, 248, 239) ;\n    width: 75%;\n    float: left;\n    margin-left: 13%;\n }\n .right{\n     width: 30%;  \n     float: left;\n }\n .left{\n    padding-left: 100px;\n     width: 50%;\n     float: left;\n     \n }\n .container{\n   \n    width: 900px;\n    \n }\n.header{\n    text-align: left;\n}\n.list {\n    width:70%;\n}\n.grid{\n    display: grid;\n    grid-template-columns: auto auto auto;\n    grid-gap: 10px;\n    padding: 5px;\n}\n.grid > div {\n    \n    border: 1px solid black;\n    text-align: center;\n    font-size: 30px;\n  }\n.image1{\n    border: 1px solid #dddddd;\n    width:300px;\n    height:300px;\n}\n.image2{\n    border: 1px solid #dddddd;\n    width:170px;\n    height:170px;\n}\n\n\n.container table {\n    width:100%;\n}\n\n.container table, tr, th, td, label, input{\n    font-size: 13px;\n    font-family: Arial, Helvetica, sans-serif;\n}\n\n.container th{\n    text-align: center;\n}\n\n\n\n.container th:hover{\n    background-color: #f5f5f5;\n}\n\n\n.image1:hover{\n    cursor: pointer;\n}\n.image2:hover{\n    cursor: pointer;\n}\n\n@media only screen and (max-width: 768px) {\n    /* For mobile phones: */\n    [class*=\"col\"] {\n       \n    }\n    .footer li{\n        list-style-type: none;\n    }\n    .big{\n        width: 100%;\n        height: 150%;\n        background-image: url(http://www.yummycrumbs.co.uk/wp-content/uploads/2016/12/nice-background.jpg);\n        background-repeat: repeat;\n    \n    }\n    .banner{\n        background-color: pink;\n        margin-left: 13%;\n        width: 75%;\n    }\n    .banner img{\n        margin-left: 11%;\n        width: 80%;\n    }\n     .tag{\n        height: auto;\n        width: 75%;\n     }\n     .tag-left{\n         float: left;\n         width: 90%;\n     }\n     .tag-right{\n        float: left;\n         width: 10%;\n     }\n     .tag-left ul{\n         list-style-type: none;\n         padding: 0px;\n     }\n     .tag-left ul li{\n         width: 20%;\n         float: left;\n    }\n     .tag-left ul li a{\n         text-decoration: none ;\n     }\n    \n     .tag-right ul{\n        list-style-type: none;\n    }\n     .tag-right ul li{\n        float: left;\n     }\n     .tag-right ul li a{\n        text-decoration: none;\n    }\n     .components{\n        background-color:rgb(221, 248, 239) ;\n        width: 75%;\n        float: left;\n        margin-left: 13%;\n     }\n     .right{\n         width: 20%;  \n         float: left;\n     }\n     .left{\n        padding: 0px;\n         width: 30%;\n         float: left;\n         \n     }\n     .container{\n       \n        width: 900px;\n        margin: auto;\n     }\n    .header{\n        text-align: left;\n    }\n    .list {\n        width:70%;\n    }\n    .grid{\n        display: grid;\n        grid-template-columns: auto auto auto;\n        grid-gap: 10px;\n        padding: 10px;\n    }\n    .grid > div {\n        background-color: rgba(255, 255, 255, 0.8);\n        border: 1px solid black;\n        text-align: center;\n        font-size: 30px;\n      }\n    .image1{\n        border: 1px solid #dddddd;\n        width:200px;\n        height:200px;\n    }\n    .image2{\n        margin-left: 100px;\n       \n        border: 1px solid #dddddd;\n        width:150px;\n        height:150px;\n    }\n    \n    \n    \n    .container table {\n        width:50%;\n        border-collapse: collapse;\n    }\n    \n    .container table, tr, th, td, label, input{\n        font-size: 13px;\n        font-family: Arial, Helvetica, sans-serif;\n    }\n    \n    .container th, td {\n        border-bottom: 1px solid #dddddd;\n        \n    }\n \n    .image1:hover{\n        cursor: pointer;\n    }\n    .image2:hover{\n        cursor: pointer;\n    }\n    \n}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(76);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(30), __webpack_require__(69)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(77);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
var _ShoppingCart = __webpack_require__(81);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'banner' },
                    _react2.default.createElement('img', { className: 'banner', src: './images/banner.jpg' })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'tag' },
                ...
                _react2.default.createElement(
                    ...
                    currentPath.includes('/about') ? _react2.default.createElement(_About2.default, null) : currentPath.includes('/changeView') ? _react2.default.createElement(_ChangeView2.default, { dispatch: this.props.dispatch, products: this.props.products }) : currentPath.includes('/categories') ? _react2.default.createElement(_Categories2.default, { dispatch: this.props.dispatch, categories: this.props.categories, editedCategory: this.props.editedCategory }) : currentPath.includes('/order') ? _react2.default.createElement(_Order2.default, { dispatch: this.props.dispatch, orders: this.props.orders, editedOrder: this.props.editedOrder }) : currentPath.includes('/ShoppingCart') ? _react2.default.createElement(_ShoppingCart2.default, { dispatch: this.props.dispatch, products: this.props.products, carts: this.props.carts }) : _react2.default.createElement(_App2.default, { dispatch: this.props.dispatch, products: this.props.products, editedProduct: this.props.editedProduct, editedProductToAdd: this.props.editedProductToAdd,
...
var About = function About() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'li',
            null,
            'Name: Nguyen Thanh Danh - ID: s3635085 '
        ),
        _react2.default.createElement(
            'li',
            null,
            'Name: Do Quoc Toan - ID: s3652979 '
        ),
        _react2.default.createElement(
            'li',
            null,
            'Name: Mai Pham Quang Huy - ID: s3618861 '
        ),
        _react2.default.createElement(
            'li',
            null,
            'Name: Hyejeong Song - ID: s3618807'
        )
    );
};
...
var ShoppingCart = function (_React$Component) {
    ...
    function ShoppingCart() {
        ...
        var _this = _possibleConstructorReturn(this, (ShoppingCart.__proto__ || Object.getPrototypeOf(ShoppingCart)).call(this));
    ...
    _createClass(ShoppingCart, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.props.dispatch((0, _main.fetchCarts)());
        }
    }, {
        key: 'handleDelete',
        value: function handleDelete(id) {
            if (confirm('Do you want to delete?')) {
                ...
                this.props.dispatch((0, _main.deleteCart)(id));
            }
        }
    }, {
        key: 'handleCheckOut',
        value: function handleCheckOut(o) {
            this.props.dispatch((0, _main.addOrder)(o));
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.carts.map(function (cart, i) {
                            return _react2.default.createElement(
                                'tr',
                                { key: i },
                                _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement('img', { src: cart.imageUrl, width: '55px', height: '55px' })
                                ),
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    _react2.default.createElement(
                                        'button',
                                        { onClick: function onClick() {
                                                return _this2.handleDelete(cart._id);
                                            } },
                                        'Delete'
                                    )
                                ),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/order', type: 'button', value: 'Checkout' },
                                'Check_Out_All'
                            )
                        )
                    )
